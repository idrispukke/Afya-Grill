...
import { STAFF_EMAIL, STAFF_PASSWORD, type StaffRole } from "@/lib/staff";
...
export function StaffLogin({
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    setTimeout(() => {
      ...
      toast.success(`Bem-vindo, equipe ${role}`);
    }, 450);
  }
      ...
      >
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <div className="mt-3 flex items-center gap-1.5">
            <img src={logo} alt="Afya Grill" className="h-4 w-4 object-contain" />
        ...
        <label className="mb-3 block text-xs">
          <span className="mb-1.5 block text-muted-foreground">E-mail da equipe</span>
